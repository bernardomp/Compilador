...
class Anasint:
    ...
    def analizaExpresionPrima(self):
        ...
        elif self.componente.cat == "PtoComa" or (self.componente.cat == "PR" and self.componente.valor in ["ENTONCES","HACER","SINO"]):
            #<expresion'> -> lambda
            pass
